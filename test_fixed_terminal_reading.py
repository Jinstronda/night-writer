#!/usr/bin/env python3
"""
Test the fixed terminal content reading system
"""
...
def test_terminal_content_reading():
    """Test the fixed terminal content reading"""
    print("Testing Fixed Terminal Content Reading")
    print("=" * 50)
    ...
    # Test 1: Terminal content with rate limit
    print("\n1. Testing with rate limit content...")
...
import { Account, AccountStatus } from '../types/session-manager';
  ⎿  5-hour limit reached ∙ resets 4am
    ...
    # Test 2: Terminal content without rate limit
    print("\n2. Testing with normal terminal content...")
    terminal_content_normal = r"""C:\Users\joaop\Documents\Hobbies\Claude Night Writer>python night_writer_cli.py
✓ Valid JSON file with 15 tasks
Starting Night Writer...
You will be prompted to select a terminal window.
...
2025-09-09 02:08:40,718 - root - INFO - Terminal started successfully
2025-09-09 02:08:40,718 - root - INFO - Executing task 0: Keep going
2025-09-09 02:08:40,718 - root - INFO - Task 0 completed with status: success
2025-09-09 02:08:40,728 - root - INFO - Task 0 output saved to night_writer_outputs\task_000_20250909_020840
2025-09-09 02:08:40,728 - root - INFO - Executing task 1: Go to the next task
2025-09-09 02:08:40,729 - root - INFO - Task 1 completed with status: success
2025-09-09 02:08:40,739 - root - INFO - Task 1 output saved to night_writer_outputs\task_001_20250909_020840
2025-09-09 02:08:40,739 - root - INFO - Executing task 2: Test everything, document, and clean the code
2025-09-09 02:08:40,739 - root - INFO - Task 2 completed with status: success
2025-09-09 02:08:40,764 - root - INFO - Task 2 output saved to night_writer_outputs\task_002_20250909_020840
2025-09-09 02:08:40,764 - root - INFO - Session completed successfully
Session completed successfully!

(graphrag-gpu) C:\Users\joaop\Documents\Hobbies\Claude Night Writer>"""
    
    result = parser.parse_output(terminal_content_normal)
    print(f"  Rate limit detected: {result['rate_limit_detected']}")
    print(f"  Reset time: {result['reset_time']}")
    print(f"  Message: {result['message']}")
    
    if not result['rate_limit_detected']:
        print("  ✅ No rate limit detected correctly!")
    else:
        print("  ❌ Rate limit incorrectly detected!")
    
    # Test 3: Time-based rate limit detection
    print("\n3. Testing time-based rate limit detection...")
    now = datetime.now()
    print(f"  Current time: {now.strftime('%H:%M')}")
    
    if now.hour < 4:
        print("  ✅ Current time is before 4am - system will wait for rate limit reset")
    else:
        print("  ✅ Current time is after 4am - system will start tasks immediately")
    
    print("\n🎉 Fixed terminal content reading is working!")
    print("The system will now:")
    print("1. Try to read existing terminal content first")
    print("2. If no content available, use time-based detection")
    print("3. Wait for detected reset times before starting tasks")
    print("4. Handle window handle errors gracefully")

if __name__ == "__main__":
    test_terminal_content_reading()
